...
G4double ArtAnalysisManager::CalculateMaterialZ(const G4String& material)
{
    ...
    if (material.contains("Lead") || material.contains("lead")) return 82;
    if (material.contains("Vermilion")) return 80; // Mercure
    if (material.contains("Lapis")) return 14; // Sodium (principal composant)
    if (material.contains("Malachite")) return 29; // Cuivre
    if (material.contains("TinYellow")) return 50; // Étain
    if (material.contains("Titanium") || material.contains("Titan")) return 22;
    if (material.contains("Calcium") || material.contains("Calc")) return 20;
    if (material.contains("Carbon") || material.contains("Canvas")) return 6;
    if (material.contains("Oxygen") || material.contains("Ox")) return 8;
    if (material.contains("Hydrogen") || material.contains("H")) return 1;
...
{
    return material.contains("Lead") || material.contains("lead") ||
           material.contains("Vermilion") || material.contains("Lapis") ||
           material.contains("Malachite") || material.contains("TinYellow");
}

G4double ArtAnalysisManager::CalculateDensity(const G4String& material)
{
    if (material.contains("Lead") || material.contains("lead")) return 6.5*g/cm3;
    if (material.contains("Vermilion")) return 8.1*g/cm3;
    if (material.contains("Lapis")) return 2.4*g/cm3;
    if (material.contains("Malachite")) return 4.0*g/cm3;
    if (material.contains("TinYellow")) return 6.8*g/cm3;
    if (material.contains("Titanium") || material.contains("Titan")) return 2.0*g/cm3;
    if (material.contains("Canvas")) return 1.5*g/cm3;
    if (material.contains("Gesso")) return 1.8*g/cm3;
    if (material.contains("Varnish")) return 1.2*g/cm3;
